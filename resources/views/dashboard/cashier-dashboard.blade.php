        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3 class="text-white">{{amountFormat($spentOnReferrences,2)}}</h3>
                <p class="text-white">Paid on referrences</p>
              </div>
              <div class="icon">
                <i><img src="{{ asset('assets/images/dashboard-img/payment.png') }}" alt="Payment" class=" img-fluid"></i>
              </div>
              <a href="{{route('admin.users')}}" class="small-box-footer text-white">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <div class="small-box bg-success">
              ...
              <div class="icon">
                ...
                <i><img src="{{ asset('assets/images/dashboard-img/dashboard-money.png') }}" alt="Save Money" class="img-fluid"></i>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <div class="small-box bg-warning">
              ...
              <div class="inner">
                ...
                <h3 class="text-white">{{amountFormat($totalWithdrawals,2)}}</h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 pl-5">
                  ...
                  <div class="banner-content">
                      ...
                      <a href="https://www.facebook.com/sharer/sharer.php?u=" class="btn social-button cusn-bg-grident">Share Now</a>
