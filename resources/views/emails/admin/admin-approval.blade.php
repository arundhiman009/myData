									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td class="bodycopy">
												...
												has Signup Now. Please Approve his request to activate the services.
                                        ...
                                        <tr>
											<td class="actionbody" align="center" valign="middle">
												...
												<a href="{{route('dashboard')}}"
												   style="border-radius: 6px;border: 1px solid #595959; 
														   		margin-top: 20px;
														    padding-bottom: 10px; padding-top: 10px; padding-left: 40px;padding-right: 40px; background-color: #e0a403;color: white;font-weight: bold;">Login now</a>
											</td>
										</tr>
                                        <tr>
								            <td height="40"></td>
										...
										<tr>
											<td>
												<table style="">
													<tr>
														<td>
															If any question, please feel free to contact us at a href="mailto:{{$adminEmail[0] }}">{{ $adminEmail[0] }}. </a>{{$adminEmail[0]}}</a>. In the meantime, please check our <a style="color: black" href="{{Config::get('app.url').'/how-it-works/faq'}}" >.
														</td>
													</tr>
												</table>
											</td>
