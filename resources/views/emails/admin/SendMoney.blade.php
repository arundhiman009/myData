...
<head>
	...
	<title>{{Config::get('app.name')}} Amount Recieved</title>
	<style type="text/css">
		body {
			margin: 0;
			padding: 0;
							...
							<tr>
								<td class="innerpadding borderbottom">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td class="bodycopy">
												{{ucfirst($data->username)}} has paid you the amount of ${{$result->amount_total /100}} {{Config::get('app.name')}}. Please Approve the transaction for Future Process.
										...
										<tr>
											<td>
												<table style="">
													<tr>
														<td>
															if you have any queries; feel free to ask us on   <a href="mailto:{{$adminEmail[0]}}">{{$adminEmail[0]}}</a>. In the meantime, please check our <a style="color: black" href="{{Config::get('app.url').'/how-it-works/faq'}}" >.
														</td>
													</tr>
												</table>
											</td>
