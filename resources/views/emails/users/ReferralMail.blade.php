							...
							<tr>
								<td class="innerpadding borderbottom">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td class="bodycopy">
												{{$user->username}} has invited you at <a href="{{Config::get('app.url')}}" >{{Config::get('app.name')}}</a> to join with them. Use the button below to set up your account and get started.
											</td>
                                        </tr>
                                        ...
                                        <tr>
											<td class="actionbody" align="center" valign="middle">
												<a href="{{$link}}"
												   style="border-radius: 6px;border: 1px solid #595959; padding-bottom: 10px; padding-top: 10px; padding-left: 40px;padding-right: 40px; background-color: #e0a403;color: white;font-weight: bold;">Register now</a>
											</td>
										</tr>
                                        <tr>
								            <td height="40"></td>
